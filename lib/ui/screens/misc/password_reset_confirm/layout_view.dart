...
class PasswordResetConfirm extends StatefulWidget {
  ...
  @override
  State<PasswordResetConfirm> createState() => _PasswordResetConfirmState();
}
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: PasswordResetConfirmWidget(),
            ),
          ],
        ),
      ),
...
class PasswordResetConfirmWidget extends StatelessWidget {
  const PasswordResetConfirmWidget({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 18),
        SizedBox(height: 26),
        ColoredButton(text: "Confirm", onPressed: () {}),
      ],
    );
  }
}
